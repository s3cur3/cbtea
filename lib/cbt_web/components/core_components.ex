defmodule CbtWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 w-72 sm:w-96 z-50 rounded-lg p-3 ring-1",
  ...
  """
  attr :distortion, Distortion, required: true

  attr :field, FormField,
    doc: "a form field struct retrieved from the form, for example: @form[:email]"

  def distortion_select(%{field: %FormField{} = field} = assigns) do
